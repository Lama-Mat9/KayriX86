...
prints: ; BX: Start of the string.  Uses FASTCALL convention.
...
printh: ; DX: The hexadecimal value to print
    
    ; Reminder: The stack goes from high to low addresses. While prints goes from low to high addresses
    ; This means that we have to print our hex in reverse
